...
\textscbf{Hadlock Tech} \hfill \textscbf{New York}

\textbf{Software Developer – RaceTix} \hfill \textbf{2026 – Present}
\begin{itemize}[noitemsep,topsep=2pt]
    \item Built RaceTix, a digital ticketing platform integrating Shopify with signed, idempotent webhooks for automated ticket issuance and QR-code fulfillment
